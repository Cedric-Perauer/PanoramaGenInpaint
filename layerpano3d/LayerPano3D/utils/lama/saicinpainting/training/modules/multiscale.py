...
class MultiscaleDiscriminatorSimple(nn.Module):
    ...
    def forward(
        ...
        return [cur_discr(cur_input) for cur_discr, cur_input in zip(
...
class MultiscaleResNetSingle(
        GeneratorMultiToSingleOutputMixin,
        SingleToMultiScaleInputMixin,
        MultiscaleResNet):
    pass
