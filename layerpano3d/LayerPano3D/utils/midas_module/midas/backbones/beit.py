...
def _get_rel_pos_bias(self, window_size):
    ...
    new_sub_table = F.interpolate(
        ...
        size=(
            ...
            new_width),
        mode="bilinear")
    new_sub_table = new_sub_table.permute(
        0, 2, 3, 1).reshape(
...
def attention_forward(self, x, resolution,
...
def block_forward(self, x, resolution,
                  shared_rel_pos_bias: Optional[torch.Tensor] = None):
    """
    ...
    if self.gamma_1 is None:
        ...
        x = x + self.drop_path(self.gamma_1 * self.attn(self.norm1(x),
                                                        resolution, shared_rel_pos_bias=shared_rel_pos_bias))
