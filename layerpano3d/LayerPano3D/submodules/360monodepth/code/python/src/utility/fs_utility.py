...
class FileNameConvention:
    ...
    def __init__(self):
        ...
        self.subimage_depthmap_erp_filename_expression = (
            "{prefix_name}_depth_erp_{:03d}.pfm"  # the radius self.depth map
        )
        ...
        self.subimage_dispmap_aligned_coeffs_filename_expression = (
            # the depth map alignment coefficients
            "{prefix_name}_disp_coeff.json"
        )
        self.subimage_pixelcorr_filename_expression = (
            # the depth map alignment corresponding relationship file
            "{prefix_name}_corr_{:03d}_{:03d}.json"
        )
