...
def rgb2ycbcr(img, y_only=False):
    ...
    if y_only:
        ...
        out_img = np.matmul(img, [[65.481, -37.797, 112.0], [128.553, -
...
def bgr2ycbcr(img, y_only=False):
    ...
    if y_only:
        ...
        out_img = np.matmul(img, [[24.966, 112.0, -18.214], [128.553, -
...
def rgb2ycbcr_pt(img, y_only=False):
    ...
    if y_only:
        ...
        out_img = torch.matmul(
            img.permute(
                0, 2, 3, 1), weight).permute(
            0, 3, 1, 2) + 16.0
    else:
        weight = torch.tensor([[65.481, -
                                37.797, 112.0], [128.553, -
                                                 74.203, -
                                                 93.786], [24.966, 112.0, -
                               18.214]]).to(img)
