...
def main():
    ...
    parser.add_argument(
        "--load-from",
        default="/mnt/petrelfs/yangshuai/4drender/Text-to-4Dscene/load/depth_anything_v2_vitl.pth",
        type=str,
    ...
    parser.add_argument(
        "--img-path",
        type=str,
        default="/mnt/petrelfs/yangshuai/4drender/Text-to-4Dscene/Depth_Anything_V2/assets/examples/demo01.jpg",
    ...
    for k, filename in enumerate(filenames):
        ...
        resized_pred = Image.fromarray(depth).resize(
        ...
        points = np.stack(
            (np.multiply(x, z), np.multiply(y, z), z), axis=-1).reshape(-1, 3)
