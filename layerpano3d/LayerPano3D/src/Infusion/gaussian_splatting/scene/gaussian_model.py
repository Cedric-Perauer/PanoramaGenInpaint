...
class GaussianModel:
    ...
    def training_setup(self, training_args):
        ...
        scale = 1
        scale_small = 1
        l = [{"params": [self._xyz], "lr": training_args.position_lr_init *
              self.spatial_lr_scale *
              scale_small, "name": "xyz", }, {"params": [self._features_dc], "lr": training_args.feature_lr *
                                              scale, "name": "f_dc"}, {"params": [self._features_rest], "lr": training_args.feature_lr *
                                                                       scale /
                                                                       20.0, "name": "f_rest"}, {"params": [self._opacity], "lr": training_args.opacity_lr *
                                                                                                 scale, "name": "opacity"}, {"params": [self._scaling], "lr": training_args.scaling_lr *
                                                                                                                             scale, "name": "scaling"}, {"params": [self._rotation], "lr": training_args.rotation_lr *
                                                                                                                                                         scale_small, "name": "rotation"}, ]
        self.params_list = l
