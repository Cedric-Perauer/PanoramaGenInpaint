...
def render_set(
    ...
    depth_path = os.path.join(
        ...
        "ours_{}".format(iteration),
        "depth")
    depth_dis_path = os.path.join(
        model_path,
        name,
        "ours_{}".format(iteration),
        "depth_dis")
    intri_path = os.path.join(
        model_path,
        name,
        "ours_{}".format(iteration),
        "intri")
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        torchvision.utils.save_image(
            rendering, os.path.join(
                render_path, view.image_name + ".png"))
        torchvision.utils.save_image(
            gt, os.path.join(
                gts_path, view.image_name + ".png"))
