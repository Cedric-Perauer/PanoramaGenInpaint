    ...
    for i in range(height - 2 * ksize - 1):
        for j in range(width - 2 * ksize - 1):
            ...
            if flag != general_mask[i + ksize, j + ksize]:
                print(flag, general_mask[i + ksize,
                      j + ksize], i + ksize, j + ksize)
            if flag:
...
# arking meter', 13: 'bench', 14: 'bird', 15: 'cat', 16: 'dog', 17: 'horse
# brella', 26: 'handbag', 27: 'tie', 28: 'suitcase', 29: 'frisbee', 30: 's
# board', 37: 'surfboard', 38: 'tennis racket', 39: 'bottle', 40: 'wine gl
# h', 49: 'orange', 50: 'broccoli', 51: 'carrot', 52: 'hot dog', 53: 'pizz
# 61: 'toilet', 62: 'tv', 63: 'laptop', 64: 'mouse', 65: 'remote', 66: 'ke
#  'book', 74: 'clock', 75: 'vase', 76: 'scissors', 77: 'teddy bear', 78:
# #  85: 'curtain', 86: 'door-stuff', 87: 'floor-wood', 88: 'flower', 89:
# , 97: 'playingfield', 98: 'railroad', 99: 'river', 100: 'road', 101: 'ro
# all-brick', 110: 'wall-stone', 111: 'wall-tile', 112: 'wall-wood', 113:
# iling-merged', 119: 'sky-other-merged', 120: 'cabinet-merged', 121: 'tab
...
for segment in segments_info:
    ...
    if args.debug:
        ...
        image_mask.save(
            os.path.join(
                panoptic_dir,
                f"panoptic_{segment_label}_{segment_id}_{score}_{depth_value}.png"))
...
if len(sorted_indices) == 0:
    ...
    print("Sorted Panoptic Depth Levels:",
          [panoptic_depths[i] for i in sorted_indices])
    ...
    for n_layer in range(len(sorted_cluster_indices)):
        ...
        mask_smooth_pil.save(
            f"{layer_dir}/layer{n_layer_reverse}_mask_smooth.png")
