...
class Regr3D(Criterion, MultiLoss):
    ...
    def compute_loss(self, gt1, gt2, pred1, pred2, **kw):
        gt_pts1, gt_pts2, pred_pts1, pred_pts2, mask1, mask2, monitoring = self.get_all_pts3d(
...
class ConfLoss(MultiLoss):
    ...
    def compute_loss(self, gt1, gt2, pred1, pred2, **kw):
        ...
        return conf_loss1 + \
            conf_loss2, dict(conf_loss_1=float(conf_loss1), conf_loss2=float(conf_loss2), **details)
...
class Regr3D_ShiftInv(Regr3D):
    ...
    def get_all_pts3d(self, gt1, gt2, pred1, pred2):
        ...
        gt_shift_z = get_joint_pointcloud_depth(
            gt_z1, gt_z2, mask1, mask2)[:, None, None]
        pred_shift_z = get_joint_pointcloud_depth(
            pred_z1, pred_z2, mask1, mask2)[:, None, None]
