...
class BaseStereoViewDataset(EasyDataset):
    ...
    def __getitem__(self, idx):
        ...
        for view in views:
            ...
            # this allows to check whether the RNG is is the same state each
            # time
    ...
    def _set_resolutions(self, resolutions):
        ...
        for resolution in resolutions:
            if isinstance(resolution, int):
                ...
                width, height = resolution
            assert isinstance(
                width, int), f"Bad type for {width=} {type(width)=}, should be int"
            assert isinstance(
                height, int), f"Bad type for {height=} {type(height)=}, should be int"
            assert width >= height
