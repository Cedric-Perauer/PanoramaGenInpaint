...
def croco_args_from_ckpt(ckpt):
    ...
    # pretrained using the official code release
        ...
        # eg "CroCoNet(enc_embed_dim=1024, enc_num_heads=16, enc_depth=24)"
        s = ckpt["args"].model
...
class CroCoDownstreamBinocular(CroCoNet):
    ...
    def encode_image_pairs(self, img1, img2, return_all_blocks=False):
        ...
        out, pos, _ = self._encode_image(torch.cat(
            (img1, img2), dim=0), do_mask=False, return_all_blocks=return_all_blocks)
