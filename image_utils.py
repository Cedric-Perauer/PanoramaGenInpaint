...
def project_mask_onto_equirect(
    ...
    return eq_y_to_highlight, eq_x_to_highlight  # Return coordinates for further use if needed
...
def visualize_all_inpainting_masks(initial_panorama,side_pano, output_size=1024):
    ...
    side_params[-3:] = side_params[-3:][::-1]  # Reverse last three for correct order of Meta paper
    ...
    view_sets = {
        ...
        "Bottom": {
            "params": [(0, 60), (130, 60),(230,60)],  # Positive pitch actually looks down in render_perspective
            "fov": 120.0,
